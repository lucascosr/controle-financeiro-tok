...
export const DashboardCharts: React.FC<DashboardChartsProps> = ({ transactions, theme = 'light' }) => {
  ...
  const tooltipStyle = {
      ...
      backgroundColor: theme === 'dark' ? '#1e293b' : '#fff', // Slate-800 vs White
      padding: '12px',
      color: theme === 'dark' ? '#f8fafc' : '#1e293b'
  };

  const axisColor = theme === 'dark' ? '#94a3b8' : '#94a3b8'; // Keeping neutral for both

  if (transactions.length === 0) {
      return (
          <div className="flex flex-col items-center justify-center h-64 glass-card dark:bg-slate-900/50 rounded-3xl border border-white/50 dark:border-slate-800 p-8 text-center">
              ...
              <p className="text-slate-500 dark:text-slate-400 font-medium">Sem dados suficientes</p>
              <p className="text-slate-400 dark:text-slate-500 text-sm mt-1">Adicione transações para visualizar a mágica acontecer.</p>
          </div>
      )
  }
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
      ...
      <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl p-6 rounded-3xl shadow-lg shadow-slate-200/50 dark:shadow-black/20 border border-white dark:border-slate-800">
          ...
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              ...
              <RechartsTooltip 
                ...
                itemStyle={{ color: theme === 'dark' ? '#e2e8f0' : '#1e293b', fontWeight: 600 }}
              />
        ...
        <div className="h-72 w-full">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              />
              <RechartsTooltip 
                cursor={{ fill: theme === 'dark' ? '#334155' : '#f1f5f9', radius: 8 }}
                contentStyle={tooltipStyle}
              />
